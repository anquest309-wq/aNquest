            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                  {/* <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-hero neon-edge">
                    <Building2 className="w-4 h-4" style={{ color: '#2d65bc' }} />
                    <span className="text-sm font-semibold theme-text-primary">Real Estate CRM Solution</span>
                  </div> */}

                  <h1 className="text-3xl md:text-4xl   font-bold theme-text-primary leading-tight">
                    Smart Real Estate CRM Solutions That <span style={{ color: '#2d65bc' }}>Close Deals Faster</span>
                  </h1>

                  <p className="text-xl theme-text-secondary leading-relaxed">
                    Automate lead tracking, property management, site visit scheduling, and sales pipeline.
                    Capture leads from all sources, nurture with intelligent follow-ups, and close more deals.
                  </p>

                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link
                      to={buildUrl('/request-a-quote')}
                      className="group px-8 py-4 rounded-xl font-bold text-lg text-white transition-all duration-300 hover:scale-105 neon-edge flex items-center justify-center gap-2"
                    ...
                    <Link
                      ...
                      className="px-8 py-4 rounded-xl font-bold text-lg glass-hero theme-text-primary border-2 border-[#2d65bc] hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                    >
                      Talk to Expert
                  ...
                  <div className="flex flex-wrap gap-6 pt-4">
                    {[
                      { icon: Users, text: 'Real Estate Clients' },
                      { icon: TrendingUp, text: '60% Higher Conversions' },
                      { icon: Star, text: '4.9/5 Rating' }
                    ].map((item, idx) => (
                      <div key={idx} className="flex items-center gap-2 theme-text-secondary">
                        <item.icon className="w-5 h-5" style={{ color: '#2d65bc' }} />
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="text-center mb-10 space-y-4">
                {/* <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-hero neon-edge mb-4">
                  <Sparkles className="w-4 h-4" style={{ color: '#2d65bc' }} />
                  <span className="text-sm font-semibold theme-text-primary">Powerful Features</span>
                </div> */}
