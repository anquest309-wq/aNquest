      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {testimonials.map((item, index) => (
            ...
            >
              {/* Animated Top Border */}
              <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-green-400 to-blue-400 rounded-t-3xl group-hover:h-3 transition-all duration-300"></div>
              
              {/* Floating Background Elements */}
              <div className="absolute top-4 right-4 w-16 h-16 bg-gradient-to-r from-green-200/20 to-blue-200/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 group-hover:scale-150 transition-all duration-700"></div>
              <div className="absolute bottom-4 left-4 w-12 h-12 bg-gradient-to-r from-blue-200/20 to-green-200/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 group-hover:scale-150 transition-all duration-700"></div>

              {/* Card Content */}
              <div className="p-8 mt-4 relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  <div className="bg-gradient-to-tr from-green-500 to-green-400 p-2 rounded-lg group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                    <svg
                ...
                <div className="flex items-center justify-between">
                  ...
                  <img
                    src={item.img}
                    alt={item.name}
                    className="w-12 h-12 rounded-full object-cover border-2 border-green-400 group-hover:border-green-500 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300"
                  />
                </div>
              </div>
