...
export default function About() {
  ...
  // Get theme color for shapes and decorations
  const getThemeColor = () => {
    if (theme === 'light') {
      return '#2d65bc';
    } else if (theme === 'dark') {
            ...
            <div className="order-1 lg:order-2 animate-slide-in-right">
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold mb-2" style={{ color: '#2d65bc' }}>{counts.clients}+</div>
                    <div className="theme-text-secondary text-sm">Happy Clients</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold mb-2" style={{ color: '#2d65bc' }}>{counts.years}+</div>
                    <div className="theme-text-secondary text-sm">Years Experience</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold mb-2" style={{ color: '#2d65bc' }}>{counts.support}/7</div>
