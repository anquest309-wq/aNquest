...
const Technologies = () => {
  ...
  const getLevelColor = (level) => {
    switch (level) {
      case "Expert": return "theme-bg-tertiary theme-text-primary";
      case "Advanced": return "theme-bg-secondary theme-text-primary";
      case "Intermediate": return "theme-bg-primary theme-text-secondary";
      default: return "theme-bg-tertiary theme-text-primary";
    }
  };
  ...
  return (
    <div className="min-h-screen theme-bg-secondary">
      ...
      <section className="theme-gradient-primary text-white py-30">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <span className="theme-bg-tertiary theme-text-primary px-4 py-2 rounded-full">50+ Technologies</span>
            <span className="theme-bg-tertiary theme-text-primary px-4 py-2 rounded-full">Expert Level</span>
            <span className="theme-bg-tertiary theme-text-primary px-4 py-2 rounded-full">Modern Stack</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 theme-bg-primary">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold theme-text-primary mb-4">Technology Stack</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {technologies.map((category, index) => (
              <div key={index} className="theme-card rounded-2xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
                <div className="flex items-center mb-6">
                  <span className="text-4xl mr-4">{category.icon}</span>
                  <h3 className="text-2xl font-bold theme-text-primary">{category.category}</h3>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {category.technologies.map((tech, techIndex) => (
                    <div key={techIndex} className="theme-border-primary border rounded-lg p-4 hover:theme-border-secondary transition-colors duration-200">
                      <div className="flex justify-between items-start mb-2">
                        <h4 className="font-semibold theme-text-primary">{tech.name}</h4>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${getLevelColor(tech.level)}`}>
                          {tech.level}
                        </span>
                      </div>
                      <p className="text-sm theme-text-muted">{tech.description}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="theme-bg-primary py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold theme-text-primary mb-4">Why Our Technology Choices?</h2>
            <p className="text-xl theme-text-secondary max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold theme-text-primary mb-3">Performance First</h3>
              <p className="theme-text-secondary">We prioritize technologies that deliver optimal performance and user experience</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold theme-text-primary mb-3">Scalable Solutions</h3>
              <p className="theme-text-secondary">Our technology stack grows with your business, ensuring long-term success</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold theme-text-primary mb-3">Future-Proof</h3>
              <p className="theme-text-secondary">We use modern, actively maintained technologies with strong community support</p>
            </div>
          </div>
        </div>
      </section>
