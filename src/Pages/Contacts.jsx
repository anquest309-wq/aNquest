                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className={`peer w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.name
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={handleInputChange}
                            className={`peer w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.email
                                ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                                : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                              }`}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            maxLength={12}
                            pattern="[0-9]{10,12}"
                            className={`peer w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.phone
                                ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                                : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                              }`}
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          onChange={handleInputChange}
                          rows={6}
                          className={`peer w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary resize-none ${formErrors.message
                              ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                              : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                            }`}
