...
const AppDevelopment = () => {
  return (
    <div className="min-h-screen theme-bg-secondary">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              <div className="w-16 h-16 theme-bg-tertiary rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 theme-accent-primary" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                </svg>
              </div>
              <h3 className="text-2xl font-bold theme-text-primary mb-4">iOS Development</h3>
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">Android Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">React Native Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">Flutter Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">Cross-Platform Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">App Maintenance</h3>
              <p className="theme-text-secondary mb-6">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 theme-gradient-accent rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="theme-text-primary font-bold text-xl">1</span>
              </div>
              <h3 className="text-xl font-bold theme-text-primary mb-4">Discovery & Planning</h3>
              <p className="theme-text-secondary">We analyze your requirements and create a detailed project plan.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold theme-text-primary mb-4">Design & Prototyping</h3>
              <p className="theme-text-secondary">We create wireframes and prototypes for your app.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold theme-text-primary mb-4">Development & Testing</h3>
              <p className="theme-text-secondary">We build your app with rigorous testing at every step.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold theme-text-primary mb-4">Launch & Support</h3>
              <p className="theme-text-secondary">We deploy your app and provide ongoing support.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 theme-gradient-accent">
        <div className="container mx-auto px-6 text-center">
          ...
          <button className="theme-button-secondary font-bold py-4 px-8 rounded-lg transition-colors duration-300">
