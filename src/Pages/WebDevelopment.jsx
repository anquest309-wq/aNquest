        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">Frontend Development</h3>
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">Backend Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">Full-Stack Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">E-Commerce Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">CMS Development</h3>
              <p className="theme-text-secondary mb-6">
            ...
            <div className="theme-card rounded-xl theme-shadow-primary p-8 hover:theme-shadow-secondary transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold theme-text-primary mb-4">Progressive Web Apps</h3>
              <p className="theme-text-secondary mb-6">
