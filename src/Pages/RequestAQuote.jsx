  ...
  return (
    <>
      ...
      <div className=" theme-bg-primary  ">
        {/* Hero Section */}
        <section className="relative overflow-hidden min-h-screen h-[550px] flex justify-center items-center sm:pt-32">
          <HomeHeroBg />
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-lg sm:text-xl theme-text-secondary mb-8 max-w-3xl mx-auto leading-relaxed">
                Share your requirements and goals with us. Our team will analyze
                your project and send you a clear, transparent, and tailored
                estimate — no hidden costs.
              </p>

              {/* VALUE POINTS */}
              <div className="flex flex-wrap justify-center gap-8 mb-10">
                <div className="flex flex-col items-center">
                  <span className="text-3xl font-bold text-[#2d65bc]">24h</span>
                  <span className="text-sm theme-text-secondary">Quick Response</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="text-3xl font-bold text-[#2d65bc]">100%</span>
                  <span className="text-sm theme-text-secondary">Transparent Pricing</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="text-3xl font-bold text-[#2d65bc]">Free</span>
                  <span className="text-sm theme-text-secondary">Consultation</span>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="theme-card rounded-3xl theme-shadow-primary p-6 sm:p-8 lg:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {status.message && (
                    <div
                      className={`rounded-2xl px-4 py-3 text-sm font-semibold ${status.type === 'success'
                  ...
                  {/* Name and Email */}
                  <div id='quote-form' className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.name
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.email
                            ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                            : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                          }`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.phone
                            ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                            : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                          }`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.service
                            ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                            : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                          }`}
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.budget
                            ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                            : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                          }`}
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary ${formErrors.timeline
                          ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                          : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                        }`}
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={6}
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all theme-bg-primary theme-text-primary resize-none ${formErrors.message
                          ? 'border-red-500 focus:ring-red-500 focus:border-red-500'
                          : 'theme-border-primary focus:ring-[#2d65bc] focus:border-[#2d65bc]'
                        }`}
